...
class select_time:
    ...
    def POST(self):
        ...
        success_message = sqlitedb.updateTime(selected_time)
        # Here, we assign `update_message' to `message', which means
        # we'll refer to it in our template as `message'
        return render_template('select_time.html', message = update_message, success_message = success_message)
...
class search:
	...
	status = post_params['status']
        result = sqlitedb.browse(itemID, category, description, minprice, maxprice, status)
